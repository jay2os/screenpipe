    ...
    let sentry_guard = if !telemetry_disabled {
        Some(sentry::init((
            ...
            sentry::ClientOptions {
                release: Some(format!("dystil-app@{}", app_version).into()),
                send_default_pii: false,
                server_name: Some("dystil-app".into()),
    ...
    let app = app.manage(recording_state)
        ...
        .setup(move |app| {
            ...
            #[cfg(target_os = "macos")]
            {
                ...
                let mut app_submenu_builder = SubmenuBuilder::new(app, "dystil")
                    .item(&PredefinedMenuItem::about(app, Some("About dystil"), None)?)
                    .separator();
                ...
                let app_submenu = app_submenu_builder
                    .item(&PredefinedMenuItem::quit(app, Some("Quit dystil"))?)
                    .build()?;
