    ...
    try {
      ...
      if (os === "windows") {
        ...
        if (gate !== "proceed") {
          ...
          toast({
            title: "Dystil is still starting up",
            description:
              gate === "errored"
        ...
        toast({
          ...
          description: "Dystil will restart automatically",
          duration: 10000,
        });
    ...
    return (
      <div className={cn(
        ...
        <div className="flex items-center gap-2 flex-1">
          ...
          <span>
            dystil <span className="font-medium">v{authRequired.version}</span> is available — sign in to download
          </span>
        </div>
  ...
  return (
    <div className={cn(
      ...
      <div className="flex items-center gap-2 flex-1">
        <Sparkles className="h-4 w-4 text-primary" />
        <span>
          dystil <span className="font-medium">v{updateInfo.version}</span> is ready
        </span>
      </div>
      <div className="flex items-center gap-2">
        <Button
